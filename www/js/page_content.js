...
function getURL(URL,cache,iframe) {
	...
	var networkState = "aaa";//navigator.connection.type;
	if (networkState == "bbb"){	//Connection.NONE) {
...
//alert("we have internet - but we have error : " + exception);
		...
		else
		{
			...
			temp_html = temp_html + '<div class="amr_header"><button id="showRightPush"></button><p class="amr_title">نهضت مردمی پوستر انقلاب</p><button onclick="go_back();" class="amr_backbtn"></button></div><br/><br/>';
